...
def _properties_from_feature(feature: ogrFeature) -> Dict[str, Any]:
    return {feature.GetFieldDefnRef(index).GetName(): feature.GetField(index) for index in range(feature.GetFieldCount())}


def _properties_from_layer(layer: Layer) -> List[Dict[str, Any]]:
